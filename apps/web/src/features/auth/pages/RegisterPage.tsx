...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterInput) => {
    ...
    try {
      ...
      toast({ title: 'Account created!', description: 'Welcome to GymArchive', variant: 'success' as any });
      navigate('/');
    } catch (error: any) {
      toast({
  ...
  return (
    <div className="relative z-0 flex min-h-screen items-center justify-center p-3 sm:p-4 overflow-hidden bg-[#050508]">
      ...
      <Card className="w-full max-w-[440px] border-emerald-500/20 bg-[#050508]/80 shadow-[0_0_60px_-15px_rgba(16,185,129,0.35)] backdrop-blur-2xl animate-scale-in p-1 sm:p-2">
